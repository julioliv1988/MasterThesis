...
dbutils.widgets.dropdown("Chosen Model", "Random Forest",["Linear Regression", "KNN", "Random Forest", "ARIMA" ],label=None)
...
if Chosen_Model == "ARIMA":
    _Chosen_Model_ = "ARIMA"
else:
    _Chosen_Model_ = Chosen_Model+" VEST"

# COMMAND ----------

if _Chosen_Model_ in Models:
    pass
else:
...
for i in range(n_windows):
    test_featured_no_season_list.append(pd.read_csv(f"/dbfs/mnt/automated_mounts_sas/0juliostoragetest/julio/master_data/SerieNumber_{SerieNumber}{decorator}/test_set_featured_no_season/window_{i}.csv", index_col=0))
    train_featured_no_season_list.append(pd.read_csv(f"/dbfs/mnt/automated_mounts_sas/0juliostoragetest/julio/master_data/SerieNumber_{SerieNumber}{decorator}/train_set_featured_no_season/window_{i}.csv", index_col=0))
...
if TS_truncated_experiment:
    ...
    if Chosen_Model == "Linear Regression":
        ...
        feature_set_no_season = ["std-1", "Last-observation", "SMA-1", "last_max"]
        feature_set_1_season = ["Repeating_Sequence-SI-1", "Repeating_Sequence-SI-2", "Repeating_Sequence-SI-3", "Repeating_Sequence-SI-4", "seasonal_std_3", "seasonal_std_diff", "SMA-1", "std-1", "Last-observation"]
        feature_set_2_season = ["Repeating_Sequence-SI-1", "Repeating_Sequence-SI-2", "Repeating_Sequence-SI-3", "Repeating_Sequence-SI-4", "Repeating_Sequence_2-SI-1", "Repeating_Sequence_2-SI-2", "Repeating_Sequence_2-SI-3", "Repeating_Sequence_2-SI-4","seasonal_std_3", "EMA-3", "SMA-1", "std-1", "seasonal_min", "seasonal_avg_2"]
        ...
        for i in range(n_windows):
            ...
            feature_set_no_season = ["Last-observation", "EMA-3", "std-1", "index", "EMA-2"]
            feature_set_1_season = ["Repeating_Sequence", "seasonal_max", "Last-observation", "index", "seasonal_min", "seasonal_avg_2", "seasonal_avg_3", "std-1", "SMA-1", "EMA-1", "seasonal_avg_diff"]
            feature_set_2_season = ["Repeating_Sequence_2", "Repeating_Sequence", "Last-observation", "seasonal_avg_2", "seasonal_max", "seasonal_min", "seasonal_avg_3", "index", "last_min", "SMA-1", "EMA-2", "EMA-1"]
