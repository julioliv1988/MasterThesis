...
[sublist[0] for sublist in dbutils.fs.ls(f'/mnt/automated_mounts_sas/0juliostoragetest/julio/master_data/')][5:]

# COMMAND ----------

for files in [sublist[0] for sublist in dbutils.fs.ls(f'/mnt/automated_mounts_sas/0juliostoragetest/julio/master_data/')][5:]:
    dbutils.fs.rm(files)

# COMMAND ----------

dbutils.fs.rm('dbfs:/mnt/automated_mounts_sas/0juliostoragetest/julio/master_data/importance_FULL_lr_window-113-iuekWtq.csv')
...
freq_calculated = pd.read_csv(f"/dbfs/mnt/automated_mounts_sas/0juliostoragetest/julio/master_data/Feature_eng/freq_calculated.csv", index_col=0)
